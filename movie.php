...
<?php
  ...
  if(isset($_POST['Submit'])) {
    ...
    //$year = $_POST['year'];
    $sort = $_POST['sort'];
    $str = " ORDER BY rating DESC";  //Initialization if no choice is given
    if($sort == 'name_asc')
      $str = " ORDER BY title";
    if($sort =='name_desc')
    ...
    if($_POST['keyword'] != "") {
      ...
      if(isset($_POST['genre'])) {
        if($_POST['year'] != ""){
          ...
          $genre = $_POST['genre'];
          $year = $_POST['year'];
          $sql = "SELECT * FROM movie NATURAL JOIN genre NATURAL JOIN movie_genre NATURAL JOIN keyword WHERE genre_type = '$genre' AND keyword = '$keyword' AND year = '$year' AND kind = 'movie'".$str;
        }
        else {
          $keyword = $_POST['keyword'];
          $genre = $_POST['genre'];
          $sql = "SELECT * FROM movie NATURAL JOIN genre NATURAL JOIN movie_genre NATURAL JOIN keyword WHERE genre_type = '$genre' AND keyword = '$keyword' AND kind = 'movie'".$str;
        }
      }
      else {
        if($_POST['year'] != ""){
          $keyword = $_POST['keyword'];
          $year = $_POST['year'];
          $sql = "SELECT * FROM movie NATURAL JOIN keyword WHERE keyword = '$keyword' AND year = '$year' AND kind = 'movie'".$str;
          ...
          $keyword = $_POST['keyword'];
          $sql = "SELECT * FROM movie natural join keyword where keyword = '$keyword' AND kind = 'movie'".$str;
      ...
      if(isset($_POST['genre'])) {
        if($_POST['year'] != ""){
          $genre = $_POST['genre'];
          $year = $_POST['year'];
          $sql = "SELECT * FROM movie NATURAL JOIN genre NATURAL JOIN movie_genre WHERE genre_type = '$genre' AND year = '$year' AND kind = 'movie'".$str;
        }
        else {
          $genre = $_POST['genre'];
          $sql = "SELECT * FROM movie NATURAL JOIN genre NATURAL JOIN movie_genre WHERE genre_type = '$genre' AND kind = 'movie'".$str;
        }
      }
      else {
        if($_POST['year'] != ""){
          $year = $_POST['year'];
          $sql = "SELECT * FROM movie WHERE year = '$year' AND kind = 'movie'".$str;
        }
        else {
            //NO OPTION GIVEN
            $sql = "SELECT * FROM movie WHERE kind = 'movie'".$str;
        }
      }
    }
    //echo $sql;
